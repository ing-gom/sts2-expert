...
.claude/skills/
  tier-judge/                     # 코스트별 효율 테이블 + 티어 판정 루브릭
...
| `data/relics_locale.json` | 유물 294종 ko/en/zh 이름+설명 |
| `data/relic_canonical_vars.json` | 유물 placeholder 실수치 (218종 추출) |
| `data/relic_axis_overrides.json` | 유물 → 카드 축 시너지 매핑 (165종) |
| `data/potions.json` | 포션 효과 분류 (⚠ 정적 카탈로그 갭 — 분류만, 수치 없음) |
